    ...
    <html lang="en">
      ...
      <body className="bg-stone-200 text-stone-900 select-none">
        <nav className="z-1000 w-full p-5 md:px-10 h-24 fixed flex justify-center items-center gap-5">
          <div className="bg-stone-100/75 border-1 border-stone-100 px-4 backdrop-blur-xs rounded-3xl grid items-center transition duration-250 grid-cols-1 lg:grid-cols-[1fr_auto_1fr] w-full lg:w-3/4">
            ...
            <div className="flex justify-center items-center text-center">
              <a href="/" onClick={handleScrollToTop} className="text-5xl font-bold px-6 pt-2 pb-4 rounded-2xl text-stone-900">
        ...
        <footer className="w-full bg-stone-900 text-stone-100 p-5 lg:p-20 mt-10">
          <div className="flex gap-10 lg:gap-5 justify-between
            ...
            <div className="flex flex-col gap-5">
              ...
              <p className="text-base lg:text-xl">Call us <a href="tel:800515516" className="underline decoration-2 hover:decoration-turquoise-blue-400 cursor-pointer transition">800 515 516</a></p>
              <p className="text-base lg:text-xl">Send us an email at <a href="mailto:info@worq.com" className="underline decoration-2 hover:decoration-turquoise-blue-400 cursor-pointer transition">info@worq.com</a></p>
              {/* Contact Icons */}
            ...
            <div className="flex flex-col justify-center w-full lg:w-auto gap-5 lg:gap-10">
              <h1 className="font-bold
                             text-lg lg:text-3xl">Subscribe and stay up to date.</h1>
              <input
                type="text"
              ...
              <div className="flex items-center gap-4">
                ...
                <p id="message" className="font-medium underline decoration-2
                               text-sm lg:text-xl"></p>
              </div>
            </div>
          </div>
        </footer>
